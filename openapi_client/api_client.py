...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = NetworkApi()
        api_instance.delete_network  # this is an instance of the class Endpoint
        api_instance.delete_network()  # this invokes api_instance.delete_network.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_network.callable or self.callable in this class
